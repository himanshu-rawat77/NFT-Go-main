  ...
  const [nfts, setNfts] = useState<NFT[]>([
    {
      ...
      description: 'Exclusive digital collectible from the iconic India Gate. Limited edition design capturing the monument\'s majestic spirit.',
    ...
    },
    {
      ...
      description: 'Iconic Delhi NFT featuring a unique perspective of the National Gallery. Collect this piece of architectural history.',
    ...
    },
    {
      ...
      description: 'Contemporary NFT art inspired by the vibrant Children\'s Park area. Each piece tells a unique story.',
    ...
    },
    {
      ...
      description: 'Sophisticated digital art collection from the Hyderabad House area. Limited availability.',
    ...
    },
    {
      ...
      description: 'Dynamic NFT artwork capturing the energy of National Stadium area. A must-have for digital art collectors.',
    ...
    },
    {
      ...
      description: 'Premium digital collectible from the prestigious C-Hexagon area. Exclusive to this location.',
    ...
    },
    {
      ...
      description: 'Urban-inspired NFT collection from the artistic heart of Central Vista. Limited edition series.',
    ...
    },
    {
      ...
      description: 'Contemporary pixel art NFT from India Gate area. A perfect blend of traditional and digital art.',
    ...
    if ("geolocation" in navigator) {
      const watchId = navigator.geolocation.watchPosition(
        ...
        (error) => {
          ...
          setError("Unable to track location. Please enable location services.");
